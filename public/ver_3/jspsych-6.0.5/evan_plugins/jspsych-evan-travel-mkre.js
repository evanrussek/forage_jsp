...
jsPsych.plugins["travel-mkre"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var harvest_key_seq = trial.harvest_key_seq; // just a key
...
//- tree_rect_height/2  - tree_circ_rad
    ...
    //  draw_harvest_key();
      ...
      //  console.log('response heard')
        ...
        var correct_key = choice_char == travel_current_key;
        var correct_keys_down = travel_keys_down();

        // if they got the wrong key, just record the data and recall the response handler.
        if (!correct_key || !correct_keys_down){
      //    console.log('wrong key')
          ...
          var data = {
            ...
            keys_held_down: correct_keys_down,
            round: round,
        ...
        } // if the travel key was not held down...
  ...
  //    draw_travel_keys();
      ...
      //    var text = 'Press sequence '+ trial.harvest_prompt + ' to HARVEST or ' + trial.travel_prompt + ' to TRAVEL to next tree.';
          var text = trial.harvest_prompt;//'Press the harvest key to HARVEST or start TRAVEL sequence to travel next tree.';
          d3.select(".prompt").text(text)
        }
