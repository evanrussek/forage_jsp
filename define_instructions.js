...
var instruction_pages_a = ['Stimuli/forage_instructions/Slide1.JPG',
...
var instruction_pages_b = ['Stimuli/forage_instructions/Slide7.JPG'];
...
var pages_a = [];
for (var i = 0; i < instruction_pages_a.length; i++){
    pages_a.push('<img src= "'+ instruction_pages_a[i] +  '" alt = "" >')
}
...
var instruction_pages_b = {
    type: 'instructions',
    pages: ['<img src= "'+ instruction_pages_b[0] +  '" alt = "" >'],
    show_clickable_nav: true
}
